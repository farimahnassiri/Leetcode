...
* are greater than or equal to x. Notice that x does not have to be an element in nums. 
...
* Explanation: No numbers fit the criteria for x. If x = 0, there should be 0 numbers >= x, 
* but there are 2. If x = 1, there should be 1 number >= x, but there are 0. If x = 2, there 
* should be 2 numbers >= x, but there are 0. x cannot be greater since there are only 2 
* numbers in nums.
* 
* Example 3:
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int[] nums1 = {3, 5};
        solution.printer(nums1);

        int[] nums2 = {0, 0};
        solution.printer(nums2);

        int[] nums3 = {0, 4, 3, 0, 4};
        solution.printer(nums3);
    }
