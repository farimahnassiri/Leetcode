...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sl.findMaximizedCapital(k1, w1, profits1, capital1)); // Output: 4
        System.out.println(sl.findMaximizedCapital(k2, w2, profits2, capital2)); // Output: 6
    }
}